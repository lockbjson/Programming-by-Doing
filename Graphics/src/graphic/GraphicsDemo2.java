...
public class GraphicsDemo2 extends Canvas {
	public void paint(Graphics g) {
		...
		g.setColor(Color.decode("#CC0099"));
		g.fillArc(300, 400, 75, 75, 45, 270);

		// custom colors
		Color myOrange = new Color(230, 92, 0); // amount of red, green, blue in
												// the color
		...
		g.setColor(Color.decode("#B3FF99"));
